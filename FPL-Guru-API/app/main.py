...
from app.routers import fplapi_router, player_comparison_router, team_router, player_router
...
# Configure logging
logging.basicConfig(
    level=logging.DEBUG,  # Set log level to DEBUG to see all messages
...
# app.dependency_overrides[IOpenAIService] = OpenAIService

# Register the routers
app.include_router(fplapi_router.router)
app.include_router(team_router.router)
app.include_router(player_router.router)
app.include_router(player_comparison_router.router) 
